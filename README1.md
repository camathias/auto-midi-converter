...
1. **Baixa** vídeos do YouTube (ex: tutoriais de piano, Synthesia)
2. **Extrai** o áudio em MP3
3. **Transcreve** para MIDI usando IA (ByteDance Piano Transcription)
4. **Organiza** tudo na pasta `~/ProjetosMidi`
...
🎹 Como Usar
Entre na pasta do projeto (se já não estiver):
cd auto-midi-converter
